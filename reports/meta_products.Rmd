...
- systematic reviews or meta-analyses focused on machine learning system aimed at:
    - detection/ diagnosis 
    - treatment selection 
    - treatment 
...
- system to be used by primary healthcare provider (no chatbots, apps for general public)
...
- database readily available to clinician 
...
- for psychotherapy studies: studies on alternative forms of therapy, such as art therapy [@kim08] or electro-compulsive therapy [@redlich_etal16], or non-therapy interactions, such as peer-topeer support [@jaroszewski_etal19] and primary care visits [@park_etal19]
- no children; 14 years or older; not excluded if mean age of training dataset was > 14 years
    ...
    - @choi_etal18: Among the 1016,583 subjects, we included 819,951 subjects after
excluding 196,632 subjects who were 14 years old or younger (prediction of 10 year suicidality)
- if multiple datasets was used for training the model, we report informationf or the combined dataset [e.g., @plitt_etal15]
